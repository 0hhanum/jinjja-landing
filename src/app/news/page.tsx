...
export default function NewsPage() {
  ...
  const newsData = [
   
    {
      ...
      content: ["You can now choose review mode."],
    },
    {
    ...
    },
    {
      ...
      content: ["Now you can peek words 👀"],
    },
    {
      title: "Jinjja News #7",
      date: "2025.12.16",
    ...
    },
    {
      ...
      images: [
        {
          src: "news_1127.png",
          alt: "Liked expressions and words now show up on the Home.",
        },
      ],
      content: ["Liked expressions and words now show up on the Home."],
    },
    {
      title: "Jinjja News #5",
      date: "2025.11.25",
